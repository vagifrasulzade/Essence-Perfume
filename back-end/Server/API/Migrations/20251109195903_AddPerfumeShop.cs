...
{
    /// <inheritdoc />
    public partial class AddPerfumeShop : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVolume", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVolume_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carts_UserId_ProductId_Volume",
                table: "Carts",
                columns: new[] { "UserId", "ProductId", "Volume" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVolume_ProductId",
                table: "ProductVolume",
                column: "ProductId");
        }
